...
class UserDaoImplTest extends BaseTestCase
{   
    ...
    {   
        $user = $this->getUserServiece()->createUser($data);
        $joinTime = $this->getUserDao()->getJoinTime(1);
        $this->assertEquals($user['joinTime'],$joinTime['joinTime']);
    }
